 ...
 */
package ch.keybridge.faces.jsf.util;
...
/**
 * The <code>&lt;o:importConstants&gt;</code> taghandler allows the developer to
 * have a mapping of all constant field values of the given fully qualified name
 * of a type in the request scope. The constant field values are those public
 ...
 * </pre>
 * <p>
 * The constant field values of the above types can be mapped into the request
 * scope as follows:
 * <pre>
 ...
 * </pre>
 * <p>
 * The map is by default stored in the request scope by the simple name of the
 * type as variable name. You can override this by explicitly specifying the
...
public class ImportConstants extends TagHandler {
   ...
   * specified in the <code>type</code> attribute from the cache. If it hasn't
   * been collected yet and is thus not present in the cache, then collect them
   ...
   * @return <code>true</code> if the given field is a constant field, otherwise
   *         <code>false</code>.
   */
